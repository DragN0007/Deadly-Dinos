...
public class StegoModel extends AnimatedGeoModel<StegoEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(StegoEntity object) {
        return model;
    }

    @Override
    public ResourceLocation getTextureLocation(StegoEntity object) {
        return object.getTextureLocation();
    }

    @Override
    public ResourceLocation getAnimationFileLocation(StegoEntity animatable) {
        return animation;
    }
}
