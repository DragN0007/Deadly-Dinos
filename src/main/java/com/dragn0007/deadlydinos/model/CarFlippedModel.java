...
public class CarFlippedModel extends AnimatedGeoModel<CarFlippedEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(CarFlippedEntity object) {
        return model;
    }

    @Override
    public ResourceLocation getTextureLocation(CarFlippedEntity object) {
        return object.getTextureLocation();
    }

    @Override
    public ResourceLocation getAnimationFileLocation(CarFlippedEntity animatable) {
        return animation;
    }
}
