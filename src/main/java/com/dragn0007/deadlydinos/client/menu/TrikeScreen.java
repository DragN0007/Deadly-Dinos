...
public class TrikeScreen extends AbstractContainerScreen<TrikeMenu> {
    ...
    public TrikeScreen(TrikeMenu trikeMenu, Inventory inventory, Component component) {
        super(trikeMenu, inventory, component);
        this.texture = trikeMenu.trike.isChested() ? CHESTED : SADDLED;
        this.imageWidth = 175;
