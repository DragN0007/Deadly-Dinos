...
public class GrypoScreen extends AbstractContainerScreen<GrypoMenu> {
    ...
    public GrypoScreen(GrypoMenu grypoMenu, Inventory inventory, Component component) {
        super(grypoMenu, inventory, component);
        this.texture = grypoMenu.grypo.isChested() ? CHESTED : SADDLED;
        this.imageWidth = 175;
