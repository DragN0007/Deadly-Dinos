...
public class IguaScreen extends AbstractContainerScreen<IguaMenu> {
    ...
    public IguaScreen(IguaMenu iguaMenu, Inventory inventory, Component component) {
        super(iguaMenu, inventory, component);
        this.texture = iguaMenu.igua.isChested() ? CHESTED : SADDLED;
        this.imageWidth = 175;
