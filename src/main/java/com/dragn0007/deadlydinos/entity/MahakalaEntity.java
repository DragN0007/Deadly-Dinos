...
public class MahakalaEntity extends TamableAnimal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected MahakalaEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true, new Predicate<LivingEntity>() {
            ...
            public boolean test(@Nullable LivingEntity livingEntity) {
                ...
                if (livingEntity instanceof UtahEntity)
                    return false;
                if (livingEntity instanceof ArchaeEntity)
                    return false;
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(MahakalaEntity.class, EntityDataSerializers.INT);
