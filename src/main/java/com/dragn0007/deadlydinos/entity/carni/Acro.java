...
public class Acro extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Acro(EntityType<? extends Animal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new DinoMeleeGoal(this, 1.8, true));
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Acro.class, EntityDataSerializers.INT);
