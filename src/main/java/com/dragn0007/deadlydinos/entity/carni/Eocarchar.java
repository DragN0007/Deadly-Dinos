...
public class Eocarchar extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Eocarchar(EntityType<? extends Animal> entityType, Level level) {
        ...
        this.targetSelector.addGoal(0, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true, new Predicate<LivingEntity>() {
            ...
            public boolean test(@Nullable LivingEntity livingEntity) {
                if (livingEntity instanceof Mahakala)
                    return false;
                if (livingEntity instanceof Eocarchar)
                    return false;
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Eocarchar.class, EntityDataSerializers.INT);
