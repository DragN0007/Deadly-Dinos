...
public class Austro extends Animal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Austro(EntityType<? extends Animal> entityType, Level level) {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Austro.class, EntityDataSerializers.INT);
