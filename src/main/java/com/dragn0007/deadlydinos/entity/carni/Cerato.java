...
public class Cerato extends TamableAnimal implements ContainerListener, Saddleable, IAnimatable {
    ...
    public static boolean checkDesertDinoSpawnRules(EntityType<Cerato> p_29550_, LevelAccessor p_29551_, MobSpawnType p_29552_, BlockPos p_29553_, Random p_29554_) {
    ...
    public static final Predicate<LivingEntity> PREY_SELECTOR = (entity) -> {
        ...
        if (entity.getType() == EntityTypes.CERATO_ENTITY.get()) {
            return false;
        }
        return true;
    };
