...
public class Dilo extends Animal implements IAnimatable {
    ...
    public Vec3 getLeashOffset() {
        return new Vec3(0D, (double)this.getEyeHeight() * 1F, (double)(this.getBbWidth() * 1.5F));
        ...
        if (super.doHurtTarget(p_32257_)) {
            if (p_32257_ instanceof LivingEntity) {
                ...
                if (i > 0) {
                    ...
                    ((LivingEntity)p_32257_).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, i * 60, 0), this);
                }
            }
