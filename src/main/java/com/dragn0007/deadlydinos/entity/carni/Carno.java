...
public class Carno extends Animal implements IAnimatable {
    ...
    public static boolean checkDesertDinoSpawnRules(EntityType<Carno> p_29550_, LevelAccessor p_29551_, MobSpawnType p_29552_, BlockPos p_29553_, Random p_29554_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new DinoWeakMeleeGoal(this, 2.2, true));
