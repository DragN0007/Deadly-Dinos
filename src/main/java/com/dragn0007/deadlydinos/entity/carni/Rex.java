...
public class Rex extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public Rex(EntityType<? extends Animal> entityType, Level level) {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Rex.class, EntityDataSerializers.INT);
