...
public class DestroyFarmGoal extends Goal {

    //For Crop Snails.

    private boolean checkState(BlockState state) {
        return state.is(BlockTags.CROPS) || state.is(Blocks.FARMLAND ) || state.is(BlockTags.SAPLINGS)
    ...
    public DestroyFarmGoal(Animal entity) {
        this.entity = entity;
