...
public class TheriEntity extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected TheriEntity(EntityType<? extends Animal> entityType, Level level) {
        ...
        this.targetSelector.addGoal(6, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true, new Predicate<LivingEntity>() {
            ...
            public boolean test(@Nullable LivingEntity livingEntity) {
                ...
                if (livingEntity instanceof StegoEntity)
                    return false;
                if (livingEntity instanceof CropSnailEntity)
                    return false;
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(TheriEntity.class, EntityDataSerializers.INT);
