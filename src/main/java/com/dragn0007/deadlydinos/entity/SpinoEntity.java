...
public class SpinoEntity extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected SpinoEntity(EntityType<? extends Animal> entityType, Level level) {
...
//            this.isInWater() = false;
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(SpinoEntity.class, EntityDataSerializers.INT);
