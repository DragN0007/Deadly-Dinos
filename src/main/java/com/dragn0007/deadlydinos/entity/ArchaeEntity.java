...
public class ArchaeEntity extends TamableAnimal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected ArchaeEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(ArchaeEntity.class, EntityDataSerializers.INT);
