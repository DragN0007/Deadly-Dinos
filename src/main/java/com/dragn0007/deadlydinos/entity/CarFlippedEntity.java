...
public class CarFlippedEntity extends Animal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected CarFlippedEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(CarFlippedEntity.class, EntityDataSerializers.INT);
