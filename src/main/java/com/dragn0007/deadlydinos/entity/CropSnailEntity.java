...
public class CropSnailEntity extends Animal implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected CropSnailEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(CropSnailEntity.class, EntityDataSerializers.INT);
