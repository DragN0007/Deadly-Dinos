...
public class TarboEntity extends Animal implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected TarboEntity(EntityType<? extends Animal> entityType, Level level) {
        ...
        this.targetSelector.addGoal(6, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true, new Predicate<LivingEntity>() {
            ...
            public boolean test(@Nullable LivingEntity livingEntity) {
                if (livingEntity instanceof MahakalaEntity)
                    return false;
                if (livingEntity instanceof TarboEntity)
                    return false;
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(TarboEntity.class, EntityDataSerializers.INT);
