...
public class DunkleoArmorItem extends ArmorItem {

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(DDDArmorMaterial.DUNKLEO, new MobEffectInstance(MobEffects.CONDUIT_POWER, 200, 0, false, false, false)).build();

    public DunkleoArmorItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
